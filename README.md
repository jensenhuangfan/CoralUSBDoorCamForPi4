...
Please refer to **DOCUMENTATION.md** for a complete breakdown of configuration, UI locking, kiosk-mode logic, intelligent volume leveling, the administrator uninstaller tool, and file security.
